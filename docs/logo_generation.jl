...
begin
	const R = 0.6 # Length of spokes
	const d = 0.5 # Diameter of balls
...
function limits(R,d)
	...
	Δx_spoke = R*cos(π/6)
	Δy_spoke = R*sin(π/6)
	xlim = (-(Δx_spoke+d/2), Δx_spoke+d/2)
	ylim = (-(Δy_spoke+d/2), R + d/2)
