...
# ╔═╡ 51a7a0f9-4782-4532-bdef-ea0e2bb16104
begin
	using Plots
	using Colors
end

# ╔═╡ c91c5409-7799-4213-98cc-3fa25306ccc6
logocolors = Colors.JULIA_LOGO_COLORS

# ╔═╡ a0202208-9335-47a4-943f-edfdcad678fc
gr()
# pgfplotsx()

# ╔═╡ 4af6d57d-69d5-4fa8-847e-64e356e6de1e
polar(r,θ) = (r*cos(θ), r*sin(θ))

# ╔═╡ ae75373b-ebc3-4a0d-8855-4204289f2ae6
let
	plt = plot(;
	    xlim=(-1,1),
	    ylim=(-1,1),
...
# ╔═╡ 9095f7fd-783b-48dd-8701-d93dcc6ba919
let
	plt2 = plot(;
	    xlim=(-1,1),
	    ylim=(-1,1),
...
manifest_format = "2.0"
project_hash = "ef6f41643187af462cbf9c7add0b539684da3b92"
